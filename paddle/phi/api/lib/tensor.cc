...
// template <typename T>
// const T *Tensor::debug_data() const {
//   if (is_debug_dense_tensor()) {
//     return static_cast<phi::DenseTensor *>(debug_impl_.get())->data<T>();
//   } else if (is_selected_rows()) {
//     return static_cast<phi::SelectedRows
//     *>(debug_impl_.get())->value().data<T>();
//   }
//   return nullptr;
// }
...
//   if (is_debug_dense_tensor()) {
//     return static_cast<phi::DenseTensor *>(debug_impl_.get())->data<T>();
//   } else if (is_debug_selected_rows()) {
//     return static_cast<phi::SelectedRows *>(debug_impl_.get())
//         ->mutable_value()
//         ->data<T>();
//   }
//   return nullptr;
